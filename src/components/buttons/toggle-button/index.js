...
class ToggleButton extends React.Component {
  ...
  render() {
    ...
    if (this.state.activeButton === 1) {
      buttonOuterStyle1 = [styles.buttonContainer, {backgroundColor: color1, zIndex: -1}];
      buttonOuterStyle2 = [styles.buttonContainer, {backgroundColor: color2, zIndex: -1}];
      ...
      buttonOuterStyle1 = [styles.buttonContainer, {backgroundColor: color2, zIndex: -1}];
      buttonOuterStyle2 = [styles.buttonContainer, {backgroundColor: color1, zIndex: -1}];
    ...
    return (
      <View style={[styles.view, this.props.style, {borderColor: color1}]}>
        <View style={[buttonOuterStyle1, {paddingRight: 20, width: 150, borderTopLeftRadius: 8, borderBottomLeftRadius: 8}]}>
        ...
        <Triangle width={50} height={29} color={activeButton === 1 ? color2 : color1} direction={'up'} style={{position: 'absolute', left: 124, bottom: 0.5}}/>

        <View style={[buttonOuterStyle2, {borderTopRightRadius: 8, borderBottomRightRadius: 8}]}>
